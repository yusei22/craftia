...
class Texture2D {
    ...
    */
    ...
    attachImage(pixcels: TexPixcels, size: Vec2,
        { enableNPOT = true, noRepeat = true, yCoordinateInversion = false }: { enableNPOT?: boolean, noRepeat?: boolean, yCoordinateInversion?: boolean } = {}) {
    ...
    attachToframebuffer(attachmentPoint: GLenum = this.gl.COLOR_ATTACHMENT0) {
        ...
        this.gl.framebufferTexture2D(
            this.gl.FRAMEBUFFER, attachmentPoint, this.gl.TEXTURE_2D, this.webGLTexture, this.level);
    }
}
export { Texture2D }
