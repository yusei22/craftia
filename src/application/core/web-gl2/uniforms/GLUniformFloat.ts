import { IGLUniform, IGLUniformValue, expandVecs } from './IGLUniform';
import { ValueUpdater } from 'application/core/types';
import { Vec, Vec2, Vec3, Vec4, isVec } from 'application/core/units';

export class GLUniformFloat<T extends IGLUniformValue = IGLUniformValue> implements IGLUniform<T> {
    private readonly gl: WebGL2RenderingContext;
    private readonly location: WebGLUniformLocation | null;
    public readonly value: T;

    public shader: number | null;
    ...
    public setValue(valOrUpdater: ValueUpdater<T> | T): GLUniformFloat<T> {
        return new GLUniformFloat(
            this.gl,
            this.location,
