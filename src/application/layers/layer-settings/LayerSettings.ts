...
class LayerSettings implements LayerSettingsParam {
    ...
    cloneEdit(editedSettings: Partial<LayerSettingsParam>) {
        return new LayerSettings({
            ...
            globalLocation: editedSettings.globalLocation ? editedSettings.globalLocation.clone() : this.globalLocation.clone(),
            ...
            shadow: typeof editedSettings.shadow === 'undefined'
                ? cloneShadowSettings(this.shadow) : cloneShadowSettings(editedSettings.shadow)
        })
    }
}
